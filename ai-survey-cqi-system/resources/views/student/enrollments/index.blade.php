...
<head>
    ...
    <title>My Enrollments — CQI System</title>
    <style>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('student.enrollments.index') }}" class="nav-link active">My Enrollments</a>
    </nav>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-status">{{ ucfirst($enrollment->studentStatus->name) }}</span></td>
