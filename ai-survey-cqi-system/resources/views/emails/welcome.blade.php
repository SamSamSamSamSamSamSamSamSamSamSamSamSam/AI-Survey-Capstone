...
<html>
<head>
    <title>Account Notification - AI Survey CQI</title>
</head>
<body style="font-family: sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee;">
        
        {{-- Check if this is a brand new account or a standard reset --}}
        ...
        @else
            ...
            <p>Hello {{ $user->name }}, we received a request to reset the password for your <strong>DCISM AI Survey CQI</strong> account.</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ route('password.reset', ['token' => $token, 'email' => $user->email]) }}" 
               style="background-color: #4a5568; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                {{ $user->must_change_password ? 'Set Your Password' : 'Reset My Password' }}
            </a>
        </div>
